...
const SignUpForm = () => {
  ...
  const addAccount=()=>{
    axios.post('http://192.168.168.219:4000/api/v1/addBankAccount', {
    ...
    const {nickName,fullName,branchName,bankName,accountNumber,IFSC,mobileNo} = bankAccount;
    ...
    return <Center w="full">
        ...
        <Box safeArea p="2" w="90%" maxW="290" py="8">
          <VStack space={3} mt="5">
            <FormControl>
              <FormControl.Label  _text={{color:'black'}}>nickName</FormControl.Label>
            ...
            <FormControl>
              <FormControl.Label  _text={{color:'black'}}>fullName</FormControl.Label>
              <Input borderColor={'black'}
              value={fullName}
            ...
            <FormControl>
              <FormControl.Label  _text={{color:'black'}}>branchName</FormControl.Label>
              <Input borderColor={'black'}
              value={branchName}
            ...
            <FormControl>
              <FormControl.Label  _text={{color:'black'}}>bankName</FormControl.Label>
              <Input borderColor={'black'}
              value={bankName}
            ...
            <FormControl>
              <FormControl.Label  _text={{color:'black'}}>accountNumber</FormControl.Label>
              <Input borderColor={'black'}  value={accountNumber}
              onChangeText={handleChange("accountNumber")} />
            </FormControl>

            <FormControl>
              <FormControl.Label  _text={{color:'black'}}>IFSC</FormControl.Label>
              <Input borderColor={'black'}  
              value={IFSC}
